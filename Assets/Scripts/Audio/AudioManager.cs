...
public class AudioManager : MonoBehaviour
{
    ...
    private void Start()
    {
        if (PlayerPrefs.HasKey("volume")) audioMixer.SetFloat("MainVolume", Mathf.Log10(PlayerPrefs.GetFloat("volume")) * 20);
        if (PlayerPrefs.HasKey("volume_game")) audioMixer.SetFloat("GameVolume", Mathf.Log10(PlayerPrefs.GetFloat("volume_game")) * 20);
        if (PlayerPrefs.HasKey("volume_ui")) audioMixer.SetFloat("UIVolume", Mathf.Log10(PlayerPrefs.GetFloat("volume_ui")) * 20);
        if (PlayerPrefs.HasKey("volume_music")) audioMixer.SetFloat("MusicVolume", Mathf.Log10(PlayerPrefs.GetFloat("volume_music")) * 20);
    }
